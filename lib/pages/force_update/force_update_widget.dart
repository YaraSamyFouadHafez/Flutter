                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              32.0, 32.0, 32.0, 0.0),
                          child: Text(
                            getRemoteConfigString('Update_Message'),
                            textAlign: TextAlign.center,
                            style: FlutterFlowTheme.of(context)
                                .headlineMedium
                                .override(
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'FORCE_UPDATE_PAGE_SKIP_BTN_ON_TAP');
                                  logFirebaseEvent('Button_update_app_state');
                                  FFAppState().SkipUpdate = true;
                                  FFAppState().update(() {});
                        ...
                        child: Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'FORCE_UPDATE_PAGE_UPDATE_NOW_BTN_ON_TAP');
                                if (isiOS) {
