...
class _AuthForgotPasswordWidgetState extends State<AuthForgotPasswordWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'authForgotPassword'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('AUTH_FORGOT_PASSWORD_authForgotPassword_');
      logFirebaseEvent('authForgotPassword_action_block');
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'fmkh52i2' /* Please fill out your email bel... */,
                                ),
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: (_model.emailAddressTextController
                                            ...
                                            : () async {
                                                logFirebaseEvent(
                                                    'AUTH_FORGOT_PASSWORD_SEND_RESET_LINK_BTN');
                                                logFirebaseEvent(
